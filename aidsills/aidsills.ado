...
program Estimate, eclass
	...
	if "`ivexpenditure'" != "" {
		...
		if "`nofirst'" == "" {
			tempname b V
			reg `ln`expenditure'' `exvar', notable
			mat `b' = e(b)
			mat `V' = e(V)
			mat coln `b' = `varn'
			mat coln `V' = `varn'
