{smcl}
{cmd:help aidsills}{right: ({browse "http://www.stata-journal.com/article.html?article=up0050":SJ16-1: st0393_1})}
{hline}
...
{p 8 15 2}
{cmd: aidsills} {it:varlist_shares} {ifin}{cmd:,}
...
{pstd}Food and Social Science Research Unit (ALISS){p_end}
{pstd}The French National Institute for Agricultural Research (INRA){p_end}
{pstd}Paris, France{p_end}
{pstd}sebastien.lecocq@ivry.inra.fr{p_end}
...
{p 4 14 2}Article:  {it:Stata Journal}, volume 16, number 1: {browse "http://www.stata-journal.com/article.html?article=up0050":st0393_1},{break}
